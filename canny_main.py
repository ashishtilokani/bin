...
def on_contour(position):
    global contours,contours_image
...
def on_trackbar(position):
    global gray,edge,col_edge,im,win_name
...
def run():
    global gray,edge,col_edge,im,win_name,contours,contours_image
    ...
    subprocess.Popen(["C:\\Program Files\\GIMP 2\\bin\\gimp-2.8.exe"])
